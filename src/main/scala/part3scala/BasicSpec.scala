...
class BasicSpec extends TestKit(ActorSystem("BasicSpec"))
  with ImplicitSender // passes testActor as implicit sender
  with WordSpecLike
  with BeforeAndAfterAll {

  override protected def afterAll(): Unit = {
    TestKit.shutdownActorSystem(system) // system provided by TestKit
  }
  ...
  "A lab test actor" should {
    ...
    "turn a string into uppercase" in {
      ...
      val reply = expectMsgType[String] // get value - can make multiple, complex assertions
