...
object MultithreadingRecap extends App {
  ...
  /*
    ...
    T1 -> -1000 = 9000 // because it is based on this.amount = 10000

    => result = 9000
    this.amount = this.amount - 1000 is NOT ATOMIC (thread safe, no two threads can execute this at the same time)
   */
  ...
  val filteredFuture = future.filter(_ % 2 == 0) // Will return orig future or NoSuchElementExcepption
