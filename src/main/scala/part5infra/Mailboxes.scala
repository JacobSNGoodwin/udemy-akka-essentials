...
object Mailboxes extends App {
  ...
  supportTicketLogger ! "[P0] FIX IT!!!"
  supportTicketLogger ! "[P2] Can you check this out"
  supportTicketLogger ! "[P1] Pretty critical"

  // after what time can I send another message and have it be prioritized correctly? -> can't
...
//  controlAwareActor ! ManagementTicket
  ...
  altControlAwareActor ! "[P0] FIX IT!!!"
